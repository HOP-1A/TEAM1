            ...
            >
              ...
              <div id="divMenu" className="flex text-[12px]">
                ...
                <div className="flex place-items-center text-white">
                  <Link id="facebook" href="https://www.facebook.com/zaryllc" target="_blank" rel="no facebook" className="ml-[20px]">
                    <svg
                  ...
                  <Link id="instagram" href="https://www.instagram.com/zary.mn.official/" target="_blank" rel="no instagram" className="ml-[20px]">
                    <Instagram id="instagram" className="h-[16px] w-[16px]" />
                  </Link>
                  <Link id="twitter" href="shttps://x.com/zarymn" target="_blank" rel="no twitter" className="ml-[20px]">
                    <Twitter
                      strokeWidth={1.5}
                      fill="white"
                      height="16px"
                  ...
                  <Link id="linkedIn" href="https://mn.linkedin.com/company/zary" target="_blank" rel="no linkedin" className="ml-[20px] mr-[20px]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
